                ...
                <Card  style={{height:'160px',width:'1000px'}}>
                    <List style={{width:'100%' ,paddingLeft:'20px',paddingRight:'20px'}}>
                        <List.Item>
                            ...
                            />
                            <div style={{ width: '370px', height: '20px', border: '1px solid #DDDDDD', borderRadius: '6px', fontSize: '14px', padding: '10px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{role.username}</div>
                        </List.Item>
                        <List.Item>
                            <List.Item.Meta
                            ...
                            />
                            <div style={{ width: '370px', height: '20px', border: '1px solid #DDDDDD', borderRadius: '6px', fontSize: '14px', padding: '10px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', background: '#F6F6F6', color:'#CCCCCC'}}>蟹老板</div>
                        </List.Item>
                    </List>
                </Card>
            </Flex>
